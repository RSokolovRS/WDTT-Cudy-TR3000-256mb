...
### Рабочие ссылки v3.9.7 (рекомендуется — без кэша jsDelivr)

| Назначение | URL |
|------------|-----|
| **Установщик** | `https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@306d9fe/install.sh` |
| routing (selective) | `https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@9e42ea8/wdtt-client/files/wdtt-routing` |
| firewall-refresh | `https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@9e42ea8/wdtt-client/files/wdtt-firewall-refresh` |
...
wget -O /tmp/wdtt-install.sh \
  https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@306d9fe/install.sh
...
Должно быть `WDTT installer v3.9.7+`, проверки `[OK] routing (nft+nftset)`, `dnsmasq nftset`, `firewall lan→wdtt`.
...
### Нет трафика в любом режиме (v3.9.7)
...
### Selective: трафик есть, но медленно (v3.9.7)
...
4. **routing v3.9.7+** — MSS clamp + `rp_filter=loose` + firewall-refresh:

```bash
uclient-fetch -O /usr/libexec/wdtt/routing \
  https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@9e42ea8/wdtt-client/files/wdtt-routing
uclient-fetch -O /usr/libexec/wdtt/firewall-refresh \
  https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@9e42ea8/wdtt-client/files/wdtt-firewall-refresh
...
### Домены не сохраняются / склеиваются / wdtt.conf пуст (v3.9.7)
