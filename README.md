...
### Рабочие ссылки v3.18.2 (эстафета групп + профили + RAW)

| Назначение | URL |
|------------|-----|
| **Установщик** | `https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@91fb98a/install.sh` |
...
wget -O /tmp/wdtt-install.sh \
  https://cdn.jsdelivr.net/gh/RSokolovRS/WDTT-Cudy-TR3000-256mb@91fb98a/install.sh
...
Должно быть `WDTT installer v3.18.2+`, проверки `[OK] routing (nft+nftset)`, `dnsmasq nftset`, `firewall lan→wdtt`.
