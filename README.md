...
**Надёжный способ** (скачать в файл, потом запустить):
...
```bash
sh <(uclient-fetch -q -O - https://raw.githubusercontent.com/RSokolovRS/WDTT-Cudy-TR3000-256mb/main/bootstrap.sh)
```
